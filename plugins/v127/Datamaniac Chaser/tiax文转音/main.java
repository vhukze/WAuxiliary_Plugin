...
static {
    ...
    VOICE_NAME_MAP.put(15, "北京地铁黄华报站");
    ...
    VOICE_NAME_MAP.put(24, "陳章 台灣男聲 活力親切");
    ...
    VOICE_NAME_MAP.put(52, "仿真人（男声、情绪平稳）");
    VOICE_NAME_MAP.put(53, "仿真人（男声、偏用于广告）");
    VOICE_NAME_MAP.put(54, "粉丝直播间喊麦");
    VOICE_NAME_MAP.put(55, "冯宝宝");
    VOICE_NAME_MAP.put(56, "フリーザ様");
    ...
    VOICE_NAME_MAP.put(157, "シャア・アズナブル");
    ...
    VOICE_NAME_MAP.put(183, "台湾女女");
    VOICE_NAME_MAP.put(184, "帅帅的大男孩 +可疑");
    VOICE_NAME_MAP.put(185, "沢城みゆき");
    VOICE_NAME_MAP.put(186, "Ran Mouri (毛利蘭)");
    VOICE_NAME_MAP.put(187, "四郎生气");
    VOICE_NAME_MAP.put(188, "田中角栄の声");
    VOICE_NAME_MAP.put(189, "户外女主播");
    VOICE_NAME_MAP.put(190, "孙笑川258");
    VOICE_NAME_MAP.put(191, "孙盈盈（声音1）");
    VOICE_NAME_MAP.put(192, "孫悟空");
    VOICE_NAME_MAP.put(193, "台湾男");
    VOICE_NAME_MAP.put(194, "太乙真人自用版");
    VOICE_NAME_MAP.put(195, "太平盛世");
    VOICE_NAME_MAP.put(196, "唐三");
    VOICE_NAME_MAP.put(197, "唐僧");
    VOICE_NAME_MAP.put(198, "糖猫米雪儿");
    VOICE_NAME_MAP.put(199, "陶矜");
    VOICE_NAME_MAP.put(200, "陶衿");
    VOICE_NAME_MAP.put(201, "特遣队员（男）.mp3");
    VOICE_NAME_MAP.put(202, "天童爱丽丝（中配）");
    VOICE_NAME_MAP.put(203, "天宇一休");
    VOICE_NAME_MAP.put(204, "甜美女主播");
    VOICE_NAME_MAP.put(205, "甜美女声");
    VOICE_NAME_MAP.put(206, "潮汐摆摆");
    VOICE_NAME_MAP.put(207, "万子颖");
    VOICE_NAME_MAP.put(208, "王琨");
    VOICE_NAME_MAP.put(209, "王琨声音模型10.17t1");
    VOICE_NAME_MAP.put(210, "王俊凯");
    VOICE_NAME_MAP.put(211, "王炸音频");
    VOICE_NAME_MAP.put(212, "王者李白");
    VOICE_NAME_MAP.put(213, "王一博");
    VOICE_NAME_MAP.put(214, "1204-女主持人");
    VOICE_NAME_MAP.put(215, "温柔动听女声");
    VOICE_NAME_MAP.put(216, "吴彦祖15");
    VOICE_NAME_MAP.put(217, "五条悟");
    VOICE_NAME_MAP.put(218, "小小班班班");
    VOICE_NAME_MAP.put(219, "闲鱼配音大壮");
    VOICE_NAME_MAP.put(220, "ギャル子");
    VOICE_NAME_MAP.put(221, "小凡-激动");
    VOICE_NAME_MAP.put(222, "小孩3");
    VOICE_NAME_MAP.put(223, "小明剑魔");
    VOICE_NAME_MAP.put(224, "小莹");
    VOICE_NAME_MAP.put(225, "新幹線・車内放送の声[男性]");
    VOICE_NAME_MAP.put(226, "新游戏解说");
    VOICE_NAME_MAP.put(227, "信ボイスver1.0");
    VOICE_NAME_MAP.put(228, "行善");
    VOICE_NAME_MAP.put(229, "熊二");
    VOICE_NAME_MAP.put(230, "旭旭宝宝");
    VOICE_NAME_MAP.put(231, "宣传片");
    VOICE_NAME_MAP.put(232, "雪莉酒（女）");
    VOICE_NAME_MAP.put(233, "二狗");
    VOICE_NAME_MAP.put(234, "月半猫");
    VOICE_NAME_MAP.put(235, "央视配音");
    VOICE_NAME_MAP.put(236, "杨幂");
    VOICE_NAME_MAP.put(237, "我叫夯大力（包像版）");
    VOICE_NAME_MAP.put(238, "仙逆1");
    VOICE_NAME_MAP.put(239, "中医提问");
    VOICE_NAME_MAP.put(240, "范志波（专家）");
    VOICE_NAME_MAP.put(241, "12.9 王鑫");
    VOICE_NAME_MAP.put(242, "俄罗斯");
    VOICE_NAME_MAP.put(243, "磁性男声");
    VOICE_NAME_MAP.put(244, "爱莉");
    VOICE_NAME_MAP.put(245, "不知火舞");
    VOICE_NAME_MAP.put(246, "赵阳");
    VOICE_NAME_MAP.put(247, "黑碎屏");
    VOICE_NAME_MAP.put(248, "赛马娘");
    VOICE_NAME_MAP.put(249, "痞老板2");
    VOICE_NAME_MAP.put(250, "fufu大王3.0（初音未来）");
    VOICE_NAME_MAP.put(251, "有兽焉 天禄");
    VOICE_NAME_MAP.put(252, "鱼木123");
    VOICE_NAME_MAP.put(253, "御女茉莉");
    VOICE_NAME_MAP.put(254, "买量解说");
    VOICE_NAME_MAP.put(255, "八重");
    VOICE_NAME_MAP.put(256, "中年老女性");
    VOICE_NAME_MAP.put(257, "眼前这位老哥");
    VOICE_NAME_MAP.put(258, "张颂文");
    VOICE_NAME_MAP.put(259, "蔚蓝档案爱丽丝中文");
    VOICE_NAME_MAP.put(260, "游戏男解说");
    VOICE_NAME_MAP.put(261, "24.12.27违医生");
    VOICE_NAME_MAP.put(262, "蔡徐坤");
    VOICE_NAME_MAP.put(263, "英国海军(British Navy)G&B");
    VOICE_NAME_MAP.put(264, "琨哥");
    VOICE_NAME_MAP.put(265, "王安宇");
    VOICE_NAME_MAP.put(266, "章鱼哥");
}
...
String getVoiceListText() {
    return getVoiceListText(null);
}

String getVoiceListText(String keyword) {
    var sb = new StringBuilder();
    var currentVoice = getString("voice", "7");
    var hasKeyword = keyword != null && !keyword.trim().isEmpty();
    var searchKey = hasKeyword ? keyword.trim().toLowerCase() : "";
    int matchCount = 0;

    if (hasKeyword) {
        sb.append("🔎 搜索结果：").append(keyword.trim()).append("\n\n");
    } else {
        sb.append("🎙️ 音色列表（共266个）：\n\n");
    }

    for (int i = 1; i <= 266; i++) {
        String name = getVoiceName(i);
        if (hasKeyword) {
            var idText = String.valueOf(i);
            var lowerName = name == null ? "" : name.toLowerCase();
            if (!(idText.contains(searchKey) || lowerName.contains(searchKey))) {
                continue;
            }
        }
        matchCount++;
        sb.append(i).append(". ").append(name);
        if (String.valueOf(i).equals(currentVoice)) {
            sb.append("   【当前默认】");
        }
        sb.append("\n");
    }

    if (hasKeyword && matchCount == 0) {
        sb.append("没有找到和「").append(keyword.trim()).append("」相关的音色。\n");
        sb.append("可尝试输入名称关键字或编号，例如：吴彦祖、爱莉、221。\n");
    }
    ...
    sb.append("\n\n📌 使用方法：\n");
    sb.append("• 查看帮助弹窗：音色列表 / 帮助 / 说明\n");
    sb.append("• 修改默认音色：音色 7\n");
    sb.append("• 默认音色生成：#tts 你好\n");
    sb.append("• 临时指定音色：#tts 3 你好\n");
    sb.append("• 在本弹窗顶部可直接搜索名称或编号\n");
    sb.append("\n说明：临时指定音色不会修改默认音色。\n");

    if (hasKeyword) {
        sb.append("\n本次共找到 ").append(matchCount).append(" 个匹配结果。");
    }
    return sb.toString();
}

void showChangeVoiceDialog() {
    var ctx = getTopActivity();
    var layout = new LinearLayout(ctx);
    layout.setOrientation(LinearLayout.VERTICAL);
    layout.setPadding(28, 28, 28, 16);

    var titleView = new TextView(ctx);
    titleView.setText("修改默认音色");
    titleView.setTextSize(17);
    titleView.setTextColor(android.graphics.Color.parseColor("#1A1A1A"));
    titleView.getPaint().setFakeBoldText(true);
    titleView.setGravity(android.view.Gravity.CENTER);
    titleView.setPadding(0, 0, 0, 22);
    layout.addView(titleView);

    var tipsView = new TextView(ctx);
    tipsView.setText("输入要设置的音色编号（1 - 266）");
    tipsView.setTextSize(14);
    tipsView.setTextColor(android.graphics.Color.parseColor("#666666"));
    tipsView.setPadding(4, 0, 4, 14);
    ...
    inputBg.setColor(android.graphics.Color.parseColor("#F5F5F5"));

    var edtVoice = new EditText(ctx);
    edtVoice.setHint("例如 221");
    edtVoice.setTextSize(15);
    edtVoice.setInputType(android.text.InputType.TYPE_CLASS_NUMBER);
    edtVoice.setText(getString("voice", "7"));
    edtVoice.setSelection(edtVoice.getText().length());
    edtVoice.setBackground(inputBg);
    edtVoice.setPadding(20, 18, 20, 18);
    layout.addView(edtVoice, new LinearLayout.LayoutParams(
            LinearLayout.LayoutParams.MATCH_PARENT,
            LinearLayout.LayoutParams.WRAP_CONTENT
    ));

    var currentVoice = getString("voice", "7");
    var infoView = new TextView(ctx);
    infoView.setTextSize(13);
    infoView.setTextColor(android.graphics.Color.parseColor("#999999"));
    if (isValidVoice(currentVoice)) {
        var currentVoiceNum = Integer.parseInt(currentVoice);
        infoView.setText("当前默认  " + currentVoice + " \u00B7 " + getVoiceName(currentVoiceNum));
    } else {
        infoView.setText("当前默认  未设置");
    }
    infoView.setPadding(4, 16, 4, 0);
    layout.addView(infoView);

    new AlertDialog.Builder(ctx)
            .setView(layout)
            .setPositiveButton("确认修改", (dialog, which) -> {
                var voiceStr = edtVoice.getText().toString().trim();
                if (voiceStr.isEmpty()) {
                    toast("请输入音色编号");
                    return;
                }
                if (!isValidVoice(voiceStr)) {
                    toast("音色编号无效，请输入 1-266");
                    return;
                }
                putString("voice", voiceStr);
                var voiceNum = Integer.parseInt(voiceStr);
                toast("默认音色已修改为：" + voiceStr + " - " + getVoiceName(voiceNum));
            })
...
void showVoiceListDialog() {
    ...
    rootLayout.setPadding(24, 24, 24, 16);

    // ---------- current voice card ----------
    var voiceCardBg = new android.graphics.drawable.GradientDrawable();
    voiceCardBg.setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
    voiceCardBg.setCornerRadius(20);
    voiceCardBg.setColor(android.graphics.Color.parseColor("#F7F8FA"));

    var voiceCard = new LinearLayout(ctx);
    voiceCard.setOrientation(LinearLayout.VERTICAL);
    voiceCard.setPadding(22, 22, 22, 20);
    voiceCard.setBackground(voiceCardBg);

    var currentVoice = getString("voice", "7");
    var voiceTitle = new TextView(ctx);
    voiceTitle.setText("当前默认音色");
    voiceTitle.setTextSize(12);
    voiceTitle.setTextColor(android.graphics.Color.parseColor("#999999"));
    voiceTitle.setPadding(0, 0, 0, 6);
    voiceCard.addView(voiceTitle);

    var voiceValue = new TextView(ctx);
    voiceValue.setTextSize(16);
    voiceValue.setTextColor(android.graphics.Color.parseColor("#1A1A1A"));
    voiceValue.getPaint().setFakeBoldText(true);
    if (isValidVoice(currentVoice)) {
        var cvn = Integer.parseInt(currentVoice);
        voiceValue.setText(currentVoice + "  \u00B7  " + getVoiceName(cvn));
    } else {
        voiceValue.setText("未设置");
    }
    voiceCard.addView(voiceValue);

    var voiceHint = new TextView(ctx);
    voiceHint.setText("共 266 个音色可用");
    voiceHint.setTextSize(12);
    voiceHint.setTextColor(android.graphics.Color.parseColor("#999999"));
    voiceHint.setPadding(0, 4, 0, 0);
    voiceCard.addView(voiceHint);

    rootLayout.addView(voiceCard);
    ...
    searchBg.setCornerRadius(28);
    searchBg.setColor(android.graphics.Color.parseColor("#F5F5F5"));

    var searchRow = new LinearLayout(ctx);
    searchRow.setOrientation(LinearLayout.HORIZONTAL);
    searchRow.setPadding(18, 12, 14, 12);
    searchRow.setBackground(searchBg);

    var searchIcon = new TextView(ctx);
    searchIcon.setText("\uD83D\uDD0D");
    searchIcon.setTextSize(16);
    searchRow.addView(searchIcon);

    var edtSearch = new EditText(ctx);
    edtSearch.setHint("搜索名称或编号");
    edtSearch.setTextSize(14);
    edtSearch.setSingleLine(true);
    edtSearch.setBackground(null);
    edtSearch.setPadding(12, 0, 0, 0);
    searchRow.addView(edtSearch, new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1.0f));

    var btnClear = new TextView(ctx);
    btnClear.setText("\u2715");
    btnClear.setTextSize(14);
    btnClear.setTextColor(android.graphics.Color.parseColor("#B0B0B0"));
    btnClear.setPadding(14, 2, 14, 2);
    searchRow.addView(btnClear);

    var searchLp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    searchLp.setMargins(0, 20, 0, 0);
    rootLayout.addView(searchRow, searchLp);
    ...
    var changeBg = new android.graphics.drawable.GradientDrawable();
    changeBg.setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
    changeBg.setCornerRadius(30);
    changeBg.setColor(android.graphics.Color.parseColor("#1677FF"));

    var btnChange = new TextView(ctx);
    btnChange.setText("修改音色");
    btnChange.setTextSize(15);
    btnChange.setTextColor(android.graphics.Color.parseColor("#FFFFFF"));
    btnChange.getPaint().setFakeBoldText(true);
    btnChange.setGravity(android.view.Gravity.CENTER);
    btnChange.setPadding(32, 15, 32, 15);
    btnChange.setBackground(changeBg);

    var resetBg = new android.graphics.drawable.GradientDrawable();
    resetBg.setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
    resetBg.setCornerRadius(30);
    resetBg.setStroke(2, android.graphics.Color.parseColor("#E0E0E0"));
    resetBg.setColor(android.graphics.Color.parseColor("#FFFFFF"));

    var btnReset = new TextView(ctx);
    btnReset.setText("重置");
    btnReset.setTextSize(15);
    btnReset.setTextColor(android.graphics.Color.parseColor("#666666"));
    btnReset.getPaint().setFakeBoldText(true);
    btnReset.setGravity(android.view.Gravity.CENTER);
    btnReset.setPadding(32, 15, 32, 15);
    btnReset.setBackground(resetBg);

    var changeLp = new LinearLayout.LayoutParams(
            LinearLayout.LayoutParams.WRAP_CONTENT,
            LinearLayout.LayoutParams.WRAP_CONTENT
    );
    changeLp.setMargins(0, 0, 18, 0);
    actionRow.addView(btnChange, changeLp);
    actionRow.addView(btnReset);
    rootLayout.addView(actionRow);

    // ---------- divider ----------
    var divider = new View(ctx);
    divider.setBackgroundColor(android.graphics.Color.parseColor("#F0F0F0"));
    var divLp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 1);
    divLp.setMargins(0, 18, 0, 8);
    rootLayout.addView(divider, divLp);

    // ---------- hint ----------
    var hintView = new TextView(ctx);
    hintView.setText("共 266 个音色");
    hintView.setTextSize(12);
    hintView.setTextColor(android.graphics.Color.parseColor("#999999"));
    hintView.setPadding(4, 4, 4, 10);
    rootLayout.addView(hintView);

    // ---------- list card ----------
    var listBg = new android.graphics.drawable.GradientDrawable();
    listBg.setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
    listBg.setCornerRadius(20);
    listBg.setColor(android.graphics.Color.parseColor("#F7F8FA"));
    listBg.setStroke(1, android.graphics.Color.parseColor("#F0F0F0"));

    var scrollView = new ScrollView(ctx);
    scrollView.setBackground(listBg);
    ...
    textView.setTextColor(android.graphics.Color.parseColor("#1A1A1A"));
    scrollView.addView(textView);

    rootLayout.addView(scrollView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 0, 1.0f));
    ...
    Runnable doSearch = new Runnable() {
        public void run() {
            var keyword = edtSearch.getText().toString().trim();
            textView.setText(getVoiceListText(keyword));
            if (keyword.isEmpty()) {
                hintView.setText("共 266 个音色");
            } else {
                hintView.setText("搜索: " + keyword);
            }
        }
    };
    ...
    dialogHolder[0] = new AlertDialog.Builder(ctx)
            .setTitle("音色列表")
            .setView(rootLayout)
...
boolean isValidVoice(String voiceStr) {
    ...
    var voiceNum = Integer.parseInt(voiceStr);
    return voiceNum >= 1 && voiceNum <= 266;
}
...
void openSettings() {
    ...
    var edtVoice = new EditText(ctx);
    edtVoice.setHint("默认音色(1-266)，默认7爱莉");
    edtVoice.setInputType(android.text.InputType.TYPE_CLASS_NUMBER);
    edtVoice.setText(getString("voice", "7"));
...
boolean onClickSendBtn(String text) {
    ...
    if (text.startsWith(voiceCmd)) {
        ...
        if (!isValidVoice(voiceStr)) {
            toast("音色编号无效，请输入 1-266，例如：音色 7");
            return true;
        }
        putString("voice", voiceStr);
        var voiceNum = Integer.parseInt(voiceStr);
